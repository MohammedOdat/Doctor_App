...
usersRouter.post("/update", upload.single("image"),authentication,addUserInfoByUserId);
...
usersRouter.get("/appointments",upload.none(),authentication,getAllAppointmentsByUserId)
